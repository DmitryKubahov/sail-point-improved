...
image::http://www.plantuml.com/plantuml/proxy?src=https://raw.githubusercontent.com/DmitryKubahov/sail-point-improved/feature/puml/docs/JavaRulesInheritance.puml[align="center"]
