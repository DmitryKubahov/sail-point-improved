...
/**
 * Test for {@link AfterProvisioningRule} class
 */
public class AfterProvisioningRuleTest {

    /**
     * Test instance of {@link AfterProvisioningRule}
     */
    private AfterProvisioningRule testRule;
    ...
    /**
     * Init {@link AfterProvisioningRuleTest#testRule} and {@link AfterProvisioningRuleTest#sailPointContext} for test
     */
    @Before
    public void init() {
        this.sailPointContext = mock(SailPointContext.class);
        this.testRule = mock(AfterProvisioningRule.class,
    ...
    public void noneNullArgumentIsNullTest() throws GeneralException {
        for (String noneNullArgument : AfterProvisioningRule.NONE_NULL_ARGUMENTS_NAME) {
    ...
    public void ruleTypeTest() {
        assertEquals("Rule type is not match", Rule.Type.AfterProvisioning.name(),
