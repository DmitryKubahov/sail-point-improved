...
/**
 * Test for {@link EmailRecipientRule} class
 */
public class EmailRecipientRuleTest {

    /**
     * Test instance of {@link EmailRecipientRule}
     */
    private EmailRecipientRule testRule;
    ...
    /**
     * Init {@link EmailRecipientRuleTest#testRule} and {@link EmailRecipientRuleTest#sailPointContext} for test
     */
    @Before
    public void init() {
        this.sailPointContext = mock(SailPointContext.class);
        this.testRule = mock(EmailRecipientRule.class,
    ...
    public void noneNullArgumentIsNullTest() throws GeneralException {
        for (String noneNullArgument : EmailRecipientRule.NONE_NULL_ARGUMENTS_NAME) {
    ...
    public void ruleTypeTest() {
        assertEquals("Rule type is not match", Rule.Type.EmailRecipient.name(),
