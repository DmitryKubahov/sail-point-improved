...
/**
 * Test for {@link IdentitySelectorRule} class
 */
public class IdentitySelectorRuleTest {

    /**
     * Test instance of {@link IdentitySelectorRule}
     */
    private IdentitySelectorRule testRule;
    ...
    /**
     * Init {@link IdentitySelectorRuleTest#testRule} and {@link IdentitySelectorRuleTest#sailPointContext} for test
     */
    @Before
    public void init() {
        this.sailPointContext = mock(SailPointContext.class);
        this.testRule = mock(IdentitySelectorRule.class,
    ...
    public void noneNullArgumentIsNullTest() throws GeneralException {
        for (String noneNullArgument : IdentitySelectorRule.NONE_NULL_ARGUMENTS_NAME) {
    ...
    public void ruleTypeTest() {
        assertEquals("Rule type is not match", Rule.Type.IdentitySelector.name(),
