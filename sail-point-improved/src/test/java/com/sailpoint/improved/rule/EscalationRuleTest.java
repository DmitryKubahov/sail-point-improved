...
public class EscalationRuleTest {
     ...
     */
    private EscalationRule testRule;
    ...
    public void init() {
        ...
        this.testRule = mock(EscalationRule.class,
    ...
    public void noneNullArgumentIsNullTest() throws GeneralException {
        for (String noneNullArgument : EscalationRule.NONE_NULL_ARGUMENTS_NAME) {
    ...
    public void ruleTypeTest() {
        assertEquals("Rule type is not match", Rule.Type.Escalation.name(),
